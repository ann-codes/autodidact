...
-   Opportunity C: A bit of the time has also been spent on going through the [HackReactor SE Basics Prep](https://www.hackreactor.com/prep-programs) [(sign in here, because it's hard to find the login)](https://auth.galvanize.com/sign_in) because I am also applying to the program, targetting their February or March 2020 FT online cohort. This is sort of a last resort if  the job applications or the appreticeship does not pan out. I've made the decision that this is abosolutely happening and I will become a developer. I settled on HR because they cost about the same as the other big ones, but requires more time commitment in the 12 weeks. More bang for your buck, if you will.
-   Other than that, I much of the time/work has been going through the Zero to Mastery course. I am really itching to start the React section soon!
