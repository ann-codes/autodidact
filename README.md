...
-   To put it plainly, this was not a good week for coding and IRL stuff. Work is now in one of the high seasons and has been getting more stressful which leaves less mental capacity for me and thinking/learning coding. There have also been some personal issues that have been occupying my spare time as well. While I still have been coding or learning to code in some capacity each day, some days only saw at best 20 mins or so going through a CodeSignal problem and that's it. 
-   While I had hoped to have it finished by now, I am still going through the Modern Javascript Bootcamp course on Udemy. I only managed to get to 82% (from 71%) by the end of this week.
-   I suppose a silver lining is that I did spend some time applying for an internal position that is not a developer/engineering job, but has some HTML/CSS/JS responsibilties. This is a lateral move of sorts that hopefully does not have a reduction in pay, but I am willing to take a small cut because provides a very clear step in the right direction. I will also be applying for other similar type roles internally if I can find any more. I am annoyed at myself that I didn't do this sooner because I am currently on a career trajectory that I am not too interested in anymore and I really need to do what I can to refocus and get on the right path. And no, I don't quite feel ready yet to apply for dev jobs right now since I have been telling myself that I 1) need a portfolio and 2) need to build a CRUD application from scratch for the experience and to add to my portfolio. I am probably a few months away from this. 
