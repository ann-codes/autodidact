...
-   Opportunity C: A bit of the time has also been spent on going through the [HackReactor SE Basics Prep](https://www.hackreactor.com/prep-programs) [(sign in here, because it's really annoying to find!)](https://auth.galvanize.com/sign_in) because I am also applying to the program, targetting their February or March 2020 cohort! This is sort of a last resort if none of the job options or the appreticeship does not pan out, I've made the decision that this is abosolutely happening. I will become a dev, dammit. 
-   Other than that, I much of the work has been going through the Zero to Mastery course. I am really itching to start the React section soon!
